...
export const Footer = () => {
  return (
    <footer className="relative overflow-x-clip">
      <div
        className="absolute h-[400px] w-[1600px] bottom-0 left-1/2 -translate-x-1/2 bg-purple-300/30 
      [mask-image:radial-gradient(50%_50%_at_bottom_center,black,transparent)] -z-50"
      ></div>
